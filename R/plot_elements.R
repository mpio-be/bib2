...
#' @rdname maps
#' @examples
#' map_base(family = 'Times') + print_ann()
map_base <- function(size = 2.5, family = 'Times', fontface = 'bold') {
      g = 
      map_empty() +
...
map_nests <- function(n, size = 2.5, family = 'Times', fontface = 'bold', title  = paste('made on:', Sys.Date() ) ) {
