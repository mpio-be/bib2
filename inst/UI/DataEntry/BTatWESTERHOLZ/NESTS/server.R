  ...
  output$run_save <- renderUI({
    ...
    # db update
      ...
      if(saved_set) {
          ...
          toastr_success( paste(nrow(x), "rows saved to database.") , position = "top-center")
          toastr_warning('Refreshing in 5 secs ...', progressBar = TRUE, timeOut = 5000, position = "top-center") 
          Sys.sleep(5)
